    ...
    <div class="site-wrapper">
        ...
        <div class="page-wrapper">
			...
			<form action="" method="post">
                <div style="border:1px solid gray;border-radius:12px;" class="widget clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        ...
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Do you want to confirm the order?');" name="submit"  class="btn btn-success btn-block" value="Order"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
